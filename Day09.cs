namespace advent_of_code_2017
{
    ...
    public class Day09
    {
        ...
        // private const string Problem1Input = @"{{},{}}";
        // private const string Problem1Input = @"{{{},{},{{}}}}";
        // private const string Problem1Input = @"{<a>,<a>,<a>,<a>}"; // score of 1.
        // private const string Problem1Input = @"{{<ab>},{<ab>},{<ab>},{<ab>}}";//, score of 1 + 2 + 2 + 2 + 2 = 9.
        // private const string Problem1Input = @"{{<!!>},{<!!>},{<!!>},{<!!>}}"//, score of 1 + 2 + 2 + 2 + 2 = 9.
        //private const string Problem1Input = @"{{<a!>},{<a!>},{<a!>},{<ab>}}";//, score of 1 + 2 = 3.
        ...
        public static int SolveProblem1()
        {
            ...
            for (int i = 0; i < Problem1Input.Length; i++)
            {
                if (ignoreNextChar)
                {
